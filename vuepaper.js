const app = Vue.createApp({
    data(){
      ...
      lectureList: [
        ...
        {title:'陳培豐 研究員',url:'activity.html',img:'sp-05.jpg',describe:"陳培豐，現任中央研究院臺灣史研究所研究員。畢業於淡水工專、日本早稻田大學日本語日本文化碩士、日本東京大學總合文化研究博士。研究專長為日治時期語言和文化思想史、臺灣文學史以及國語同化政策研究。著有：《歌唱臺灣：連續殖民下臺語歌曲的變遷》、《想像和界限：臺灣語言文體的混生》、《「同化」の同床異夢：日治時期臺灣的語言政策、近代化與認同》。2013年以《想像和界線：臺灣語言文體的混生》獲得102年度科技部傑出研究獎。2024年榮獲「國家科學及技術委員會112年度傑出研究獎」。",classification:"「島鏈Ｘ文學」"},

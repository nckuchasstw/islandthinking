const app = Vue.createApp({
    data(){
      ...
      {title:'歷史Ｘ文學Ｘ生態讀書會',url:'activity.html',author:'--',img:'bookclub-06.jpg',data:"2023.9.16",register:'活動已結束'},
      {title:'「從社會層面―考察思想史的意義」大師講座',url:'https://activity.ncku.edu.tw/index.php?c=apply&no=13840',author:'王汎森',img:'lecture-01.jpg',data:"2023.10.11",register:'開放報名中'},
      {title:'文學主題讀書會',url:'activity.html',author:'陳文松、莫加南',img:'bookclub-08.jpg',data:"2023.10.11",register:'尚未開放報名'},
      {title:'生態主題讀書會',url:'activity.html',author:'王毓正',img:'bookclub-09.jpg',data:"2023.10.13",register:'尚未開放報名'},
      {title:'歷史主題讀書會',url:'activity.html',author:'沈玉慧',img:'bookclub-07.jpg',data:"2023.11.11",register:'尚未開放報名'},
